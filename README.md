...
Challenge IDs are generated by the database and remain stable. Images are stored using paths based on their challenge IDs, preserving the relationship between a challenge and its image.
